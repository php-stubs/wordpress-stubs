...
final class CallToParameterTest extends IntegrationTest
{
    public function testGetListTable(): void
    {
        $this->analyse(
            __DIR__ . '/data/_get_list_table_params.php',
            [
    ...
    {
        $this->analyse(
            __DIR__ . '/data/absint_params.php',
            [
    ...
    {
        $this->analyse(
            __DIR__ . '/data/add_menu_page_params.php',
            [
