 ...
 */
return [
    'add_meta_box' => [null, 'context'=>'"normal"|"side"|"advanced"', 'priority'=>'"high"|"core"|"default"|"low"'],
    ...
    'remove_meta_box' => [null, 'context'=>'"normal"|"side"|"advanced"'],
    ...
    'WP_List_Table::bulk_actions' => [null, 'which'=>'"top"|"bottom"'],
    'WP_List_Table::display_tablenav' => [null, 'which'=>'"top"|"bottom"'],
    'WP_List_Table::pagination' => [null, 'which'=>'"top"|"bottom"'],
    'WP_List_Table::set_pagination_args' => [null, 'args'=>'array{total_items?: int, total_pages?: int, per_page?: int}'],
    'wp_next_scheduled' => [null, 'args'=>$cronArgsType],
    'WP_Post_Type::__construct' => [null, 'args'=>'array<string, mixed>'],
    ...
    'WP_Taxonomy::__construct' => [null, 'args'=>'array<string, mixed>'],
    'wp_unschedule_event' => ['($wp_error is false ? bool : true|\WP_Error)', 'args'=>$cronArgsType],
    'wp_unslash' => ['T', '@phpstan-template'=>'T', 'value'=>'T'],
    'wp_widget_rss_form' => [null, 'args'=>$wpWidgetRssFormArgsType, 'input'=>$wpWidgetRssFormInputType],
    ...
    'WP_REST_Request::offsetSet' => [null, '@phpstan-template'=>'TOffset of key-of<T>', 'offset'=>'TOffset', 'value'=>'T[TOffset]'],
    'WP_REST_Request::offsetUnset' => [null, '@phpstan-template'=>'TOffset of key-of<T>', 'offset'=>'TOffset'],
    ...
    'WP_Block_List::offsetSet' => [null, 'index'=>'int|null'],
    'WP_Block_List::offsetUnset' => [null, 'index'=>'int'],
