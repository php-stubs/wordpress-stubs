...
return [
    ...
    'WP_Post_Type::__construct' => ['post_type'=>'string', 'args'=>$registerPostTypeArgsType],
    ...
    'WP_Taxonomy::__construct' => ['void', 'taxonomy'=>'string', 'object_type'=>'array|string', 'args'=>$registerTaxonomyArgsType],
