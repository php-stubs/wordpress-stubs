...
return [
    ...
    'WP_List_Table' => [null, '@phpstan-template' => 'T of array<string, float|int|string>|object'],
    'WP_List_Table::get_columns' =>[ 'array<key-of<T>, string>' ],
    'WP_List_Table::get_sortable_columns' =>[ 'array<key-of<T>, string>' ],
    'WP_List_Table::get_default_primary_column_name' =>[ 'key-of<T>' ],
    'WP_List_Table::get_primary_column' =>[ 'key-of<T>' ],
    'WP_List_Table::get_primary_column_name' =>[ 'key-of<T>' ],
    'WP_List_Table::single_row' =>[ null, 'item' => 'T' ],
    'WP_List_Table::column_default' =>[ null, 'item' => 'T', 'column_name' => 'key-of<T>' ],
    'WP_List_Table::column_cb' =>[ null, 'item' => 'T' ],
    'WP_List_Table::single_row_columns' =>[ null, 'item' => 'T' ],
    'WP_List_Table::handle_row_actions' =>[ null, 'item' => 'T', 'column_name' => 'key-of<T>', 'primary' => 'key-of<T>' ],
