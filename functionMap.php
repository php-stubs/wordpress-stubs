...
return [
    ...
    '_wp_upload_dir' => ['array{path: non-falsy-string, url: non-falsy-string, subdir: string, basedir: non-falsy-string, baseurl: non-falsy-string, error: false}'],
    ...
    'add_settings_field' => ['void', 'args' => 'array{label_for?: string, class?: string, ...}'],
    'add_shortcode' => [null, 'tag' => 'non-empty-string', 'callback' => 'callable(array<string>, string|null, string): string'],
    ...
    'do_action' => [null, 'hook_name' => 'non-empty-string'],
    'do_action_ref_array' => [null, 'hook_name' => 'non-empty-string'],
    'do_action_deprecated' => [null, 'hook_name' => 'non-empty-string'],
    ...
    'get_terms' => ["(\$args is array{fields: 'count', ...} ? 0|numeric-string : (\$args is array{fields: 'names'|'slugs', ...} ? list<string> : (\$args is array{fields: 'id=>name'|'id=>slug', ...} ? array<int, string> : (\$args is array{fields: 'id=>parent', ...} ? array<int, int> : (\$args is array{fields: 'ids'|'tt_ids', ...} ? list<int> : array<int, \WP_Term>)))))|\WP_Error", 'deprecated' => "''"],
    ...
    'paginate_links' => ["(\$args is array{total: int<min, 1>, ...} ? null : (\$args is array{type: 'array', ...} ? list<string> : string))"],
    ...
    'register_uninstall_hook' => [null, 'callback' => 'callable(): void'],
    ...
    'wp_count_terms' => ['0|numeric-string|\WP_Error', 'deprecated' => "''"],
    ...
    'wp_get_elements_class_name' => ['lowercase-string&non-falsy-string'],
    ...
    'wp_get_upload_dir' => ['array{path: string, url: string, subdir: string, basedir: string, baseurl: string, error: false|string}'],
    ...
    'wp_list_post_revisions' => [null, 'type' => "'all'|'revision'|'autosave'"],
    ...
    'wp_unique_id' => ["(\$prefix is ''|numeric-string ? numeric-string : string)&non-falsy-string&(\$prefix is lowercase-string ? lowercase-string : string)", '@phpstan-impure' => ''],
    ...
    'wp_unique_prefixed_id' => ["(\$prefix is ''|numeric-string ? numeric-string : string)&non-falsy-string&(\$prefix is lowercase-string ? lowercase-string : string)", '@phpstan-impure' => ''],
    ...
    'wp_upload_dir' => ['array{path: string, url: string, subdir: string, basedir: string, baseurl: string, error: false|string}'],
    ...
    'WP_Query::query' => ["(\$query is array ? (\$query is array{fields: 'id=>parent'|'ids', ...} ? array<int, int> : array<int, \WP_Post>) : array<int, int>|array<int, \WP_Post>)"],
    ...
    'WP_Term_Query::query' => ["(\$query is array ? (\$query is array{fields: 'count', ...} ? 0|numeric-string : (\$query is array{fields: 'names'|'slugs', ...} ? list<string> : (\$query is array{fields: 'id=>name'|'id=>slug', ...} ? array<int, string> : (\$query is array{fields: 'id=>parent', ...} ? array<int, int> : (\$query is array{fields: 'ids'|'tt_ids', ...} ? list<int> : array<int, \WP_Term>))))) : 0|numeric-string|array<int, int|string|\WP_Term>)"],
    'WP_Theme' => [
        null,
